          ...
          <div className="text-lg leading-relaxed space-y-6 text-gray-800">
            ...
            <div className="bg-gray-50 p-6 rounded-lg mt-8">
              ...
              <ul className="space-y-2 mb-4">
                <li className="flex items-start">
                  <Check className="w-5 h-5 text-[#FF6200] mr-2 flex-shrink-0 mt-0.5" />
                  <span>45-seconds long</span>
                </li>
                <li className="flex items-start">
                  <Check className="w-5 h-5 text-[#FF6200] mr-2 flex-shrink-0 mt-0.5" />
                  <span>Professional editing and color grading</span>
                </li>
                <li className="flex items-start">
                  <Check className="w-5 h-5 text-[#FF6200] mr-2 flex-shrink-0 mt-0.5" />
                  <span>Optimized for web and social media</span>
                </li>
              </ul>
              <Button 
                asChild
            ...
            <div className="bg-gray-50 p-6 rounded-lg">
              ...
              <ul className="space-y-2 mb-4">
                <li className="flex items-start">
                  <Check className="w-5 h-5 text-[#FF6200] mr-2 flex-shrink-0 mt-0.5" />
                  <span>1.5-minutes long</span>
                </li>
                <li className="flex items-start">
                  <Check className="w-5 h-5 text-[#FF6200] mr-2 flex-shrink-0 mt-0.5" />
                  <span>In-depth storytelling with multiple scenes</span>
                </li>
                <li className="flex items-start">
                  <Check className="w-5 h-5 text-[#FF6200] mr-2 flex-shrink-0 mt-0.5" />
                  <span>Perfect for converting website visitors into clients</span>
                </li>
              </ul>
              <Button 
                asChild
      ...
      <section id="founding-opportunities" className="py-20 bg-gray-50" ref={foundingOpportunitiesRef as any}>
        <div className="container max-w-6xl">
          ...
          <div className="mt-16 max-w-2xl mx-auto bg-gray-50 rounded-lg p-8">
            <h3 className="text-3xl mb-6 text-center">Request Founding Partner Information</h3>
